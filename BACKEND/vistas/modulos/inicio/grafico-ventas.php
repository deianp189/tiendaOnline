    ...
    <div class="box-footer no-border">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
                ...
                <input type="text" class="knob" data-readonly="true" value="<?php echo round($porcentajePaypal); ?>"
            ...
            <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
                ...
                <input type="text" class="knob" data-readonly="true" value="<?php echo round($porcentajePayu); ?>"
                    data-width="60" data-height="60" data-fgColor="#39CCCC">
