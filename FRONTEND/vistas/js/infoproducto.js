...
$('.flexslider ul li img').click(function () {
    ...
    $(".infoproducto figure.visor img").hide(); //Cuando hago click en una imagen de abajo aparece la primera
...
/*=============================================
EFECTO LUPA (cuando el cursor pasa por encima hace zoom)
=============================================*/
...
//Para que el visor se mueva junto al cursor
...
/*=============================================
CONTADOR DE VISTAS (prescindible)
=============================================*/
var contador = 0;
