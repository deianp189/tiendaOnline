...
=============================================*/
//Con localSorage puedes seguir guardando cosas en tu carrito sin el login y cerrando la pagina

//Si trae informacion la capturo
...
//Recorre todo lo que tenga en listaProductos para comparar si estan repetidos o no
			for(var i = 0; i < listaProductos.length; i++){
  //Si corresponde con el tipo de producto
            ...
            //Guardar todos los datos con push en tipo JSON
		...
		var cantidadCesta = Number($(".cantidadCesta").html()) + 1; //Suma 1 a la cesta
...
/*=============================================
/*=============================================
FUNCIÓN PARA EL CAMBIO DE DIVISA (prescindible)
=============================================*/
