                ...
                echo '<li class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <figure>
                        <a href="'.$value["ruta"].'" class="pixelProducto">
                            ...
                            <img src="'.$urlbackend.$value["portada"].'"
                        ...
                        if($value["tipo"] == "virtual" && $value["precio"] !=0){
                            ...
                            if($value["oferta"] !=0){
                                ...
                                echo '   <button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value["id"].'"
                                            imagen="'.$urlbackend.$value["portada"].'"
    ...
    foreach ($modulos[$i] as $key => $value) {
        ...
        echo '<li class="col-xs-12">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                ...
                <figure>
                    <a href="'.$value["ruta"].'" class="pixelProducto"><img
                            src="'.$urlbackend.$value["portada"].'"
       ...
       echo' <div class="btn-group pull-left enlaces">
            ...
            if($value["tipo"] == "virtual" && $value["precio"] != 0){
                ...
                if($value["oferta"] != 0){
                    ...
                    echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$urlbackend.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precioOferta"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
                    ...
                    echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value["id"].'" imagen="'.$urlbackend.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
