...
//Si esta variable no existe devuelve la url donde esta
        ...
        <div class="tab-content">
            ...
            <div id="compras" class="tab-pane fade in active">
                ...
                $compras = ControladorUsuarios::ctrMostrarCompras($item, $valor);
                    //Si no teiene compras muestra el siguiente mensaje
                	if(!$compras){
                        ...
                        foreach ($compras as $key => $value21) {

                            $ordenar = "id";
							$item = "id";
							$valor = $value21["id_producto"];

                            $productos = ControladorProductos::ctrListarProductos($ordenar, $item, $valor);

                            foreach ($productos as $key => $value22) {
                                         ...
                                         <div class="panel-body">
											...
											<div class="col-md-2 col-sm-6 col-xs-12">
                                            	...
                                            	<figure>
													...
													<img class="img-thumbnail" src="'.$servidor.$value22["portada"].'">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                ...
                                                <h1><small>'.$value22["titulo"].'</small></h1>

                                                <p>'.$value22["titular"].'</p>';


                                                if($value22["tipo"] == "virtual"){
                                                    ...
                                                    echo '<h6>Proceso de entrega: '.$value22["entrega"].' días hábiles</h6>';
                                                	...
                                                	echo '<h4 class="pull-right"><small>Comprado el '.substr($value21["fecha"],0,-8).'</small></h4>';
                ...
                <div class="row">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 text-center">
                            ...
                            //Si es modo directo me muestra los siguientes datos
         ...
         echo '<li class="col-md-3 col-sm-6 col-xs-12">
                ...
                <figure>
                    ...
                    <a href="'.$value2["ruta"].'" class="pixelProducto">
                        ...
                        <img src="'.$urlbackend.$value2["portada"].'"
                    ...
                    <div class="col-xs-6 enlaces">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <button type="button" class="btn btn-default btn-xs quitarDeseo" idDeseo="'.$value1["id"].'" data-toggle="tooltip"
                            ...
                            if($value2["tipo"] == "virtual" && $value2["precio"] !=0){
                                ...
                                if($value2["oferta"] !=0){
                                    ...
                                    echo '   <button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value2["id"].'"
                                                imagen="'.$urlbackend.$value2["portada"].'"
                                                titulo="'.$value2["titulo"].'" precio="'.$value2["precioOferta"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip"
                                    ...
                                    echo '<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="'.$value2["id"].'"
                                                imagen="'.$urlbackend.$value2["portada"].'"
                                                titulo="'.$value2["titulo"].'" precio="'.$value2["precio"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip"
                                                title="Agregar al carrito de compras">
                        ...
                        echo' <a href="'.$value2["ruta"].'" class="pixelProducto">
        ...
        <div class="modal-body modalTitulo">
            ...
            <form method="post" onsubmit="return validarComentario()">
                ...
                <div class="form-group">
                    ...
                    <label for="comment" class="text-muted">Tu opinión acerca de este producto: <span><small>(máximo 300
                                caracteres)</small></span></label>
