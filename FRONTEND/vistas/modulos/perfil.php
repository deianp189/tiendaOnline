							...
							foreach ($productos as $key => $value2) {
								...
								echo '<div class="panel panel-default">
									    ...
									    <div class="panel-body">
											...
											//Para determinar cuandos e ha enviado y cuandoe ste en proceosd e envio
													// if($value1["envio"] == 0){
										...
										<small>
											...
											<a href="'.$url.$value2["ruta"].'" class="pixelProducto">
												...
												if($value2["oferta"] != 0){
													...
													echo '<span class="label label-warning fontSize">'.$value2["descuentoOferta"].'% DESCUENTO</span>';
										...
										if($value2["oferta"] != 0){
											...
											echo '<h2 style="margin-top:-10px">
													...
													<small>
														...
														<strong class="oferta" style="font-size:12px">'.$value2["precio"].' €</strong>
											...
											echo '<h2 style="margin-top:-10px"><small>'.$value2["precio"].' €</small></h2>';
