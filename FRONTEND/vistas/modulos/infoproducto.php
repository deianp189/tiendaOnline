...
<div class="container-fluid infoproducto">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $multimendia = json_decode($infoproducto["multimedia"],true);
        ...
        /*=============================================
        VISOR DE VIDEO (prescindible)
        =============================================*/

        echo '<div class="col-sm-6 col-xs-12">

            <iframe class=" videoPresentacion" src=" https://www.youtube.com/embed/'.$infoproducto["multimedia"].'?rel=0&autoplay=0"
        ...
        ?>
            ...
            <!--=====================================
				COMPARTIR EN REDES SOCIALES (prescindible)
				======================================-->
            ...
            if($infoproducto["detalles"] != null){
                ...
                } else{//Else para productos digitales
                    //prescindible
        ...
        <div class="row">
            ...
            <div class="col-xs-12 tituloDestacado">
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    //Trae informacion de esa subcategoria
