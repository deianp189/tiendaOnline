								...
								<small>
									...
									<a href="'.$url.$value["ruta"].'" class="pixelProducto">
										...
										if($value["oferta"] != 0){
											...
											echo '<span class="label label-warning fontSize">'.$value["descuentoOferta"].'% DESCUENTO</span>';
								...
								<small>
									...
									<a href="'.$url.$value["ruta"].'" class="pixelProducto">
										...
										if($value["oferta"] != 0){
											...
											echo '<span class="label label-warning">'.$value["descuentoOferta"].'% DESCUENTO</span>';
